...
const TOOLS = [
  {
    ...
    desc: "여러 엑셀 파일을 컬럼 기반으로 자유롭게 \n 매핑하고 미리보기 후 다운로드 할 수 있습니다.",
  ...
  },
  {
    ...
    name: "PDF 편집기",
    desc: "PDF를 자유롭게 편집합니다.\n드래그 앤 드롭으로 간단하게 사용하세요.",
              ...
              {TOOLS.map((tool) => {
                ...
                return (
                  <div key={tool.name} className="card" style={{
                    ...
                    <p style={{ fontSize: "14px", color: "var(--text-secondary)", lineHeight: 1.65, flex: 1, whiteSpace: "pre-line" }}>{tool.desc}</p>
